...
conv1_act_pool = MaxPool2D(pool_size = (2, 2), strides = (2, 2), padding = 'same')(conv1_act)

# layer - 2
conv2_1 = Conv2D(filters = 16, kernel_size = (1, 1), strides = (1, 1), padding = 'same')(conv1_act_pool)
...
pool2_4 = MaxPool2D(pool_size = (3, 3), strides = (1, 1), padding = 'same')(conv1_act_pool)
pool2_4_conv = Conv2D(filters = 16, kernel_size = (1, 1), strides = (1, 1), padding = 'same')(pool2_4)
...
# layer - 4
dense4 = Dense(units = 1024, kernel_regularizer = 'l2')(flatten3_drop)
dense4_act = LeakyReLU(alpha = 0.3)(dense4)
dense4_act_drop = Dropout(rate = 0.5)(dense4_act)

# layer - 5
dense5 = Dense(units = NUM_CLASS, kernel_regularizer = 'l2')(dense4_act_drop)
...
model.load_weights(filepath = './Models/v1.h5')
...
try:
	...
	model.save_weights(filepath = './Models/v1.h5')
except:
